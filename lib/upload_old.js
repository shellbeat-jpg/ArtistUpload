...
// Konfiguration: Der globale Docker-Mutterordner aus der .env
const azuraBaseDir = process.env.AZURACAST_MEDIA_BASE_PATH;

// Alle neuen Uploads ALLER Stationen landen temporär im gemeinsamen Sammelordner /_data/new/
...
const audioDir = azuraBaseDir 
    ? path.join(azuraBaseDir, 'new') 
    : path.join(__dirname, '..', 'uploads');
// Ordner automatisch anlegen, falls noch nicht vorhanden
